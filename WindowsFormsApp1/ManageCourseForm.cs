...
namespace WindowsFormsApp1
{
    public partial class ManageCourseForm : Form
    {
        ...
        private void button_update_Click_1(object sender, EventArgs e)
        {
            ...
            if (textBox_Cname.Text == "" || textBox_Chour.Text == "" || textBox_CId.Text.Equals(""))
            {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Error course no updated", "Update Course", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private void button_delete_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Course Id missing", "Field Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                try
                {
                    ...
                    if (course.deleteCourse(id))
                    {
                        showData();
                        button_clear.PerformClick();
                        MessageBox.Show("Course has been deleted successfully", "Update Course", MessageBoxButtons.OK, MessageBoxIcon.Information);

                    }
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.Message, "Course Remove", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
